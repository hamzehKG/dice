...
public class Main {
    ...
    static final int TOTAL_RUN = 1000;
     ...
     * @param numOfDice - The initial number of dices in the game
     * @return The final score of the game
     */
    public static int playBoardGame(int numOfDice){
        int finalScore = 0;
    ...
    public static void main(String[] args) {
        runSimulation(TOTAL_RUN, NUM_OF_DICE);
    }
}